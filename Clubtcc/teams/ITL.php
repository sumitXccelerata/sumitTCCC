          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/TL.png?v=1" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>ITON TORONTO LEGENDS (ITL)</h2> 
              <div>
             <p style="text-align: justify;">
               Toronto Legends came into being in 2017 with an intent to bring in like mindedindividuals with the sole aim of enjoying the weekends playing recreational cricket.Win or loose is an outcome of the day. However the club’s motto is to have fun, relax and replenish your inner energy. Additionally we encourage all our teammembers to play hard, party hard and maintain the decorum of the gentlemen's game at all times.
             </p>

             <p style="text-align: justify;">
               The team constitutes a bunch of passionate cricketers from various walks of life who are well placed in their professional careers. This is the second year of Legends existence.
             </p>
            </div>
