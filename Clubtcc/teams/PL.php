        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/pl.jpg" class="teamBackground" alt="PL - TCC Teams" /> 
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/pl.png" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Punjab Lions (PL)</h2>
            <div>
             <p style="text-align: justify;">
               Punjab Lions Cricket Club (PL) was founded in 2007 by Harsh Sudhir and a bunch of his friends Jatinder Sidhu and Harpreet Dhillon. In its first year, Lions played with many competitive and friendly teams. Those were interesting years where we have formed and normed as a team. In 2008 Punjab Lions joined an little known league which advertise big on local radio show. In the very first year at this league PL reached the semi finals and were all excited to join more prominent leagues. This lead us to join Brampton Cricket League in 2009. That year PL won the Championship under Harpreet Dillion. More recently in 2016 we decided to pursue and play with Toronto City Cricket Club given the great reviews of this Club in the Greater Toronto Areas. 
             </p>
            </div>
        ...
        <div class="row title">
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/pl.jpg" alt="TCCC 15 in review: 14 magic moments - Cricket News" />
        ...
        <div class="row">
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a data-action-url="#" data-url = "../img/team/PL/t1.jpg" 
                      data-photo-caption = "Punjab Lions"  class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/PL/t1.jpg" alt="Punjab Lions">
              ...
              <li><a data-action-url="#" data-url = "../img/team/PL/t2.jpg" 
                      data-photo-caption = "Punjab Lions"  class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/PL/t2.jpg" alt="Punjab Lions">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/PL/t3.jpg" 
                      data-photo-caption = "Punjab Lions" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/PL/t3.jpg" alt="Punjab Lions">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/4.jpg"
                     data-photo-caption = "Punjab Lions" data-thumb ="../img/team/68196.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/4.jpg" alt="Punjab Lions">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/5.jpg"
                      data-photo-caption = "Punjab Lions" data-thumb ="../img/team/68197.jpg" class="photoThumb supersizedModal"> <span class="thumbnail">
                        <span class="imgContainer">
