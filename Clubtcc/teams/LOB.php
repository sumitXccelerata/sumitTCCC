        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/teamh/TLJ.png" class="teamBackground" alt="TLJ - TTCC Teams" /> 
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/LOB.png" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Loblaw's Cricket Club ( LOB)</h2>
            <div>
              <p style="text-align: justify;">
                The vision of Loblaw Cricket Club is to promote “Cricket for Healthy Living” and generate interest and participation in the sport of cricket on a sustainable basis by participating in social and competitive cricket across Canada. It also provides a platform to the colleagues to adopt an active and healthy lifestyle, nurture multiculturalism, and network with each other for games, jobs, and business.
              </p>
              <br/>
              <p style="text-align: justify;">
                Loblaw Cricket Club traces its roots to the friendly cricket games organized among various teams since 2008. It was officially launched in 2010 by Baljit Bawa, Gurpreet Singh & Manmeet Soni. LCC first participation started at T-20 Corporate Cricket Tournament, in 2011, participated in Community Cricket Festivals in partnerships with the community charity partners, Canadian Cancer Society and Heart and Stroke Foundation, in Mississauga and Brampton. 
              </p>
              <p style="text-align: justify;">
                Loblaw Cricket Club participation eligibility: any Full Time, Part-Time, Contract, Retired or Ex-Employee of any of the companies under Loblaw. The spouses, siblings and family members of the staff could also participate subject to availability of spots and players eligibility rules in different leagues / tournaments.
              </p>
            </div>
        ...
        <div class="row title">
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/13.jpg" alt="TCCC 15 in review: 14 magic moments - Cricket News" />
        ...
        <div class="row">
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a data-action-url="#" data-url = "../img/team/1.jpg" 
                      data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/68193.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/1.jpg" alt="TCCC Cricket Club">
              ...
              <li><a data-action-url="#" data-url = "../img/team/2.jpg" 
                      data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/68194.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/2.jpg" alt="TCCC Cricket Club">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/3.jpg" 
                      data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/68195.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/3.jpg" alt="TCCC Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/4.jpg"
                     data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/68196.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/4.jpg" alt="TCCC Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/5.jpg"
                      data-photo-caption = "TCCC Cricket Club"data-thumb ="../img/team/68197.jpg" class="photoThumb supersizedModal"> <span class="thumbnail">
                        <span class="imgContainer">
                          <img src="../img/team/5.jpg" alt="Pakistan players celebrate a Zimbabwe wicket.">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                        </span>
                      </span>
