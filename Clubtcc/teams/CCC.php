        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/teamh/TLJ.png" class="teamBackground" alt="TLJ - TCC Teams" />               
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                 <img src="../img/teamslogos/CCC.jpg" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Champions Cricket Club (CCC)</h2>
            <div>
              <p style="text-align: justify;">The Team CCC (Champions Cricket Club) </p>
              <br/>
