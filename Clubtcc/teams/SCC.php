          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                 <img src="../img/teamslogos/SCC.jpg" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Strikers Cricket Club (SCC)</h2>
            <div>
              <p style="text-align: justify;">
                Strikers Cricket Club was formed in 2016 by a group of friends to enjoy the game of cricket over the weekends. We are a growing club and a club who strive to play the Game Hard and Fair.
              </p>
