          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/MW.jpg" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Marathi Warriors Cricket Club(MW)</h2>
            <div>
             <p></p>
            </div>
          ...
          <div class="columns large-12">
            <header class="sectionHeader cta">
              <h3 class="sectionTitle">PHOTOSTREAM</h3>
                <a href="../photos.html" class="button primary">View All<i class="icon-angle-right"></i>
              </a>
            </header>

            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a data-action-url="#" data-url = "../img/team/1.jpg" 
                      data-photo-caption = "Marathi Warriors Cricket Club" data-thumb ="../img/team/68193.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/1.jpg" alt="Marathi Warriors Cricket Club">
              ...
              <li><a data-action-url="#" data-url = "../img/team/2.jpg" 
                      data-photo-caption = "Marathi Warriors Cricket Club" data-thumb ="../img/team/68194.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/2.jpg" alt="Marathi Warriors Cricket Club">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/3.jpg" 
                      data-photo-caption = "Marathi Warriors Cricket Club" data-thumb ="../img/team/68195.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/3.jpg" alt="Marathi Warriors Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/4.jpg"
                     data-photo-caption = "Marathi Warriors Cricket Club" data-thumb ="../img/team/68196.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/4.jpg" alt="Marathi Warriors Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/5.jpg"
                      data-photo-caption = "Marathi Warriors Cricket Club" data-thumb ="../img/team/68197.jpg" class="photoThumb supersizedModal">
                      <span class="thumbnail">
                        <span class="imgContainer">
