        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/teamh/T-Blues.JPG" class="teamBackground" alt="TB - TTCC Teams" /> 
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/t-blues.png" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Toronto Blues Cricket Club (T-Blues)</h2>
            <div>
             <p style="text-align: justify;">
               Toronto Blues (www.torontoblues.ca) is a new and reinvented team, launched in the summer of 2019. Toronto Blue’s are a bunch of simple blokes who happen to be passionate about the game of cricket and come from all walks of life within the GTA.
             </p>

             <p style="text-align: justify;">
               Toronto Blues club’s motto is to provide a platform for the participating members to have fun, relax and replenish your inner energy indulging in sport and other extra curricular activities that promotes active living. It is based on the foundational principles of diversity, inclusion & equality.  
             </p>
              <p style="text-align: justify;">
              We encourage all our participating members to play hard, build their own people networks, party hard but maintain the decorum of the gentlemen's game at all times.
             </p>
             <p style="text-align: justify;">
             We look forward to season 2019 with Toronto City Cricket League (TCCC).
             </p>
            </div>
        ...
        <div class="row title">
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/teamh/T-Blues.JPG" alt="Toronto Blues Cricket Club " />
          ...
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a data-action-url="#" data-url = "../img/team/1.jpg" 
                      data-photo-caption = "Toronto Blues Cricket Club " data-thumb ="../img/team/68193.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/1.jpg" alt="Toronto Blues Cricket Club ">
              ...
              <li><a data-action-url="#" data-url = "../img/team/2.jpg" 
                      data-photo-caption = "Toronto Blues Cricket Club " data-thumb ="../img/team/68194.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/2.jpg" alt="Toronto Blues Cricket Club ">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/3.jpg" 
                      data-photo-caption = "Toronto Blues Cricket Club " data-thumb ="../img/team/68195.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/3.jpg" alt="Toronto Blues Cricket Club ">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/4.jpg"
                     data-photo-caption = "Toronto Blues Cricket Club " data-thumb ="../img/team/68196.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/4.jpg" alt="Toronto Blues Cricket Club ">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/5.jpg"
                      data-photo-caption = "Toronto Blues Cricket Club "data-thumb ="../img/team/68197.jpg" class="photoThumb supersizedModal"> <span class="thumbnail">
                        <span class="imgContainer">
