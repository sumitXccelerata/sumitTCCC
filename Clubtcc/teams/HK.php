        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/teamh/TLJ.png" class="teamBackground" alt="HK - TTCC Teams" /> 
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/hk.jpg" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Hawks Cricket Club (HK)</h2>
            <div>
             <p style="text-align: justify;">
               Hawks Cricket Club is making its debut in the upcoming 2019 season in TCCC Cricket League. We are a group that has been playing the sport together for a few years. As life gets busy with young families and demanding jobs, we are looking to pursue our passion for sport in the shorter format of the game. 
             </p>

             <p style="text-align: justify;">
               We intent to play the game the rightway win or lose, and we intend to keep the games fun for all involved. Our aim is to compete and enjoy the games.
             </p>
            </div>
        ...
        <div class="row title">
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/hk.jpg" alt="Hawks Cricket Club" />
          ...
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a data-action-url="#" data-url = "../img/team/1.jpg" 
                      data-photo-caption = "Hawks Cricket Club" data-thumb ="../img/team/68193.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/1.jpg" alt="Hawks Cricket Club">
              ...
              <li><a data-action-url="#" data-url = "../img/team/2.jpg" 
                      data-photo-caption = "Hawks Cricket Club" data-thumb ="../img/team/68194.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/2.jpg" alt="Hawks Cricket Club">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/3.jpg" 
                      data-photo-caption = "Hawks Cricket Club" data-thumb ="../img/team/68195.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/3.jpg" alt="Hawks Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/4.jpg"
                     data-photo-caption = "Hawks Cricket Club" data-thumb ="../img/team/68196.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/4.jpg" alt="Hawks Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/5.jpg"
                      data-photo-caption = "Hawks Cricket Club"data-thumb ="../img/team/68197.jpg" class="photoThumb supersizedModal"> <span class="thumbnail">
                        <span class="imgContainer">
