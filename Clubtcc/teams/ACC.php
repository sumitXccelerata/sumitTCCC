        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/team/ACC/profile.jpg" class="teamBackground" alt="TLJ - TTCC Teams" />               
              <span class="curve large"></span> 
            </div>
          </div>
        </div>
        <div class="clear-both"> </div>
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                 <img src="../img/teamslogos/ACC.png" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Asian Cricket Club (ACC)</h2>
            <div>
              <p style="text-align: justify;">The Team ACC (Asian Cricket Club) came into existence in late 2007 The passion
                for cricket from Mr. Roshan Lall , Rajesh Bains (Bittu), Kalpesh Patel and Baljinder
                Habib has resulted in the formation of a Team ACC( Asian Cricket Club). The moto
                of the team was to provide equal cricketing opportunities to like minded and
                passionate cricketers. The Team ACC always believe in disciplined approach and
                respect for all.</p>
              <br/>
              <p style="text-align: justify;">
                Since 2007, The Team ACC has participated in many tournaments including TCCC league in Canada & USA  and always played a competitive  cricket . The Team ACC was winner of the many Tournaments  in  Canada and USA. The Team Core members Mr. Vibu Parkash, Mr. Satinder Sharma, Mr. Vimal Patel, Mr. Sanjay Patel . Mr. Neerav Shukla & Mr. Vikas Kukreja has contributed from the bottom of  their heart for the success of team ACC.
              </p>
        ...
        <div class="row title">
          <div class="columns large-12 title">
            <header class="sectionHeader">
              ...
              <!-- <a href="" class="button primary">View All Videos<i class="icon-angle-right"></i></a> -->
            </header>
          </div>
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/team/ACC/profile.jpg" alt="TCCC 15 in review: 14 magic moments - Cricket News" />
        ...
        <div class="row">
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a href="javascript:void(0)" data-action-url="#" data-url = "../img/team/ACC/t1.jpg" 
                      data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/ACC/t1.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/ACC/t1.jpg" alt="TCCC Cricket Club">
              ...
              <li><a href="javascript:void(0)" data-action-url="#" data-url = "../img/team/ACC/t2.jpg" 
                      data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/ACC/t2.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/ACC/t2.jpg" alt="TCCC Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a href="javascript:void(0)" data-action-url="#" data-url = "../img/team/ACC/t3.jpg" 
                      data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/ACC/t3.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/ACC/t3.jpg" alt="TCCC Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a href="javascript:void(0)" data-action-url="#" data-url = "../img/team/ACC/t4.jpg"
                     data-photo-caption = "TCCC Cricket Club" data-thumb ="../img/team/ACC/t4.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/ACC/t4.jpg" alt="TCCC Cricket Club">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
