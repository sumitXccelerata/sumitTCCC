        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/tlj.jpg" class="teamBackground" alt="TLJ - TCC Teams" /> 
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/TLJ.png" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>TORONTO LUMBER JACK (TLJ)</h2> 
            <div>
             <p style="text-align: justify;">
               Founder Naresh Jain, President, TLJ - A businessman with substantial interests in Real estate investments and Credit collection agencies. Naresh has established his wide ranging businesses in the Toronto area for more than 30 yrs and is well respected in the field for his charitable and philanthropic work throughout his life. Served on the Board of the Toronto City Cricket Club, EIPROC, Religious organizations. He led TLJ team to participate in Golden Oldies Festival held in Harrohate, North Yorkshire, UK in August 2010, Adelaide, Australia in November 2012, Cape Town, South Africa in March 2015 and several other tours.
             </p>
             <p style="text-align: justify;">
               Wazir Khullar, Past Director TLJ - An accountant with abundance of experience in City Taxation. He was an instrument in establishing Toronto City Cricket Club in 1985 that has over 150 members. He is the head of organizing league games of eight teams for the entire summer and arranging semi-finals and finals in a style in presence of City dignitaries.
             </p>
             <p style="text-align: justify;">
               Dr. Anup Gupta, Director and tour captain, TLJ- Cardiologist. Passionate medical practitioner and cricketor. Well known for his humble nature. 
              Anil Gupta, Captain- IT guru, dedicated to TLJ due to his passion for cricket and TLJ philosophy and comradeship.
             </p>
             <h3>Our Philosophy</h3>
             <p style="text-align: justify;">
                • Communication 
                • Commitment    
                • Compassion (concern for fellowman)
              </p>
              <h3>Our Mission</h3>
              <p style="text-align: justify;">
              The first cricket club of its kind in the Greater Toronto area that strives to support development of cricket among 35 yrs and older players, by providing members with the best possible motivation, training and match play by organizing matches and participate in appropriate tournaments both local and international.
              To educate general public and create brotherhood and awareness of the great game of cricket.
              To foster goodwill and spirit of sportsmanship.
             </p>
            </div>
        ...
        <div class="row title">
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/tlj.jpg" alt="TCCC 15 in review: 14 magic moments - Cricket News" />
        ...
        <div class="row">
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a  data-action-url="#" data-url = "../img/team/TLJ/t1.jpg" 
                      data-photo-caption = "TORONTO LUMBER JACK" data-thumb ="../img/team/68193.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/TLJ/t1.jpg" alt="TORONTO LUMBER JACK">
              ...
              <li><a  data-action-url="#" data-url = "../img/team/TLJ/t2.jpg" 
                      data-photo-caption = "TORONTO LUMBER JACK" data-thumb ="../img/team/68194.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/TLJ/t2.jpg" alt="TORONTO LUMBER JACK">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a  data-action-url="#" data-url = "../img/team/TLJ/t3.jpg" 
                      data-photo-caption = "TORONTO LUMBER JACK" data-thumb ="../img/team/68195.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/TLJ/t3.jpg" alt="TORONTO LUMBER JACK">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
