        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/teamh/TTN.jpg" class="teamBackground" alt="TTN - TTCC Teams" /> 
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/Titans.png" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Titans Cricket Club (TTN)</h2>
            <div>
             <p style="text-align: justify;">
              Titans a “A team of passionate cricketers who play cricket for the love of cricket!”
             </p>

             <p style="text-align: justify;">
               Majority of the players came together as “The Falcons” in 2014 and won the CIMA Mayor’s Cup in Toronto in their first season of coming together.  For the last 4 years, the players have been playing in different  leagues across the GTA.  Once again they have come together as the “Titans” to push forward as a team and reclaim glory.  A few fresh faces have boosted the strength of the team and  are eager to make their own mark within the team.  
             </p>
              <p style="text-align: justify;">
             A mix of youth and experience,  this team boasts on the strength of thinking cricketers.  The bowlers know their skills and can trouble any batsmen.  Our batsmen can take any challenge out of the park, literally.
             </p>
             <p style="text-align: justify;">
        ...
        <div class="row title">
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/teamh/TTN.jpg" alt="Titans Cricket Club " />
          ...
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a data-action-url="#" data-url = "../img/team/1.jpg" 
                      data-photo-caption = "Titans Cricket Club " data-thumb ="../img/team/68193.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/1.jpg" alt="Titans Cricket Club ">
              ...
              <li><a data-action-url="#" data-url = "../img/team/2.jpg" 
                      data-photo-caption = "Titans Cricket Club " data-thumb ="../img/team/68194.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/2.jpg" alt="Titans Cricket Club ">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/3.jpg" 
                      data-photo-caption = "Titans Cricket Club " data-thumb ="../img/team/68195.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/3.jpg" alt="Titans Cricket Club ">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/4.jpg"
                     data-photo-caption = "Titans Cricket Club " data-thumb ="../img/team/68196.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/4.jpg" alt="Titans Cricket Club ">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/5.jpg"
                      data-photo-caption = "Titans Cricket Club "data-thumb ="../img/team/68197.jpg" class="photoThumb supersizedModal"> <span class="thumbnail">
                        <span class="imgContainer">
