        ...
        <div>
          <div class="">
            <div class="teamBackground"> 
              <img src="../img/rm.jpg" class="teamBackground" alt="RM - TTCC Teams" /> 
          ...
          <div class="teamContent">
            <div class="row">
              <div class="columns large-12">
                <div class="teamLogos">
                  <img src="../img/teamslogos/rm.png" class="teamlogo">
                </div>
              </div>
            </div>
            <h2>Royal Mavericks (RM)</h2>
            <div>
             <p style="text-align: justify;">
               In November of 2015, a bunch of enthusiastic cricketers who used to play for a Cricket Club associated with a big bank ventured into an indoor cricket league named Lakeshore Cricket League to play the sport they love and named the new team ‘Royal Mavericks’.
             </p>

             <p style="text-align: justify;">
               With bowlers who swing the ball for about a foot in the air, the spinner who is the fastest bowler in the team to the Batsman who can tie you up at the edge of your seats with their breathtaking stroke-play, we truly are the Mavericks.
             </p>

             <p style="text-align: justify;">
               Few months ago, wonder who would have placed their bet on us to win a championship, but we won our first big trophy on April 24, 2016. Royal Mavericks won Lakeshore Cricket League championship in the first tournament we played together as a team. Our team members respect the game, stand with each other in thick and thin, and know how to have fun. This is our secret.
             </p>

             <p style="text-align: justify;">
               This is only the beginning. We are here to have fun and win many more championships in the coming years. For the love of the game.
             </p>
            </div>
        ...
        <div class="row title">
          ...
          <div class="columns large-5">
            <div class="videoWrapper">
              <img src="../img/rm.jpg" alt="Royal Mavericks" />
          ...
          <div class="columns large-12">
            ...
            <ul class="photoGrid small-block-grid-2 medium-block-grid-3 large-block-grid-3">
              <li><a data-action-url="#" data-url = "../img/team/1.jpg" 
                      data-photo-caption = "Royal Mavericks" data-thumb ="../img/team/68193.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/1.jpg" alt="Royal Mavericks">
              ...
              <li><a data-action-url="#" data-url = "../img/team/2.jpg" 
                      data-photo-caption = "Royal Mavericks" data-thumb ="../img/team/68194.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                          <img src="../img/team/2.jpg" alt="Royal Mavericks">
                          <span class="curve black"></span>
                          <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/3.jpg" 
                      data-photo-caption = "Royal Mavericks" data-thumb ="../img/team/68195.jpg" class="photoThumb supersizedModal">
                    <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/3.jpg" alt="Royal Mavericks">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                    </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/4.jpg"
                     data-photo-caption = "Royal Mavericks" data-thumb ="../img/team/68196.jpg" class="photoThumb supersizedModal"> 
                     <span class="thumbnail">
                      <span class="imgContainer">
                        <img src="../img/team/4.jpg" alt="Royal Mavericks">
                        <span class="curve black"></span>
                        <span class="photoIcon"></span>
                      </span>
                      </span>
              ...
              <li><a data-action-url="#" data-url = "../img/team/5.jpg"
                      data-photo-caption = "Royal Mavericks"data-thumb ="../img/team/68197.jpg" class="photoThumb supersizedModal"> <span class="thumbnail">
                        <span class="imgContainer">
