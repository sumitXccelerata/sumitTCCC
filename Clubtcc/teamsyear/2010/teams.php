                        ...
                        <div class="section">
                          ...
                          <div class="content">
                            <ul>
                              ...
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="FinalStanding.html">Final Standing</a></span>
                                  ...
                                  <div class="row">
                                    <div class="columns large-12"> 
                                      <div class="tableHeader colour0">
                                        <h5 class="subHeading" style="text-align: center;">TORONTO CITY CRICKET CLUB( TCCC) LEAGUE 2010 - TEAMS</h5>
                                      </div>
                                        <div style="padding:10px;">
                                          ...
                                          <p style="margin: 6pt 0in;"><span style="color: rgb(27, 0, 255);"><b>4. EXCEL</b></span></p>
                                          <p style="margin: 6pt 0in;"><span style="color: rgb(27, 0, 255);"><b>5. KPMG Cricket Club (KPMG)</b></span></p>
                                          <p style="margin: 6pt 0in;"><span style="color: rgb(27, 0, 255);"><b>6. ONTARIO WOMAN CRICKET CLUB (OWCC)</b></span></p>
                                          <p style="margin: 6pt 0in;"><span style="color: rgb(27, 0, 255);"><b>7. THUNDERBOLTS (TB)</b></span></p>
                                          <p style="margin: 6pt 0in;"><span style="color: rgb(27, 0, 255);"><b>8. TORONTO LUMBER JACK(TLJ)</b></span></p>
                                        </div>
                                    </div><!-- End large - 12 -->
                                  </div>
                                </div>
