                        ...
                        <div class="section">
                          ...
                          <div class="content">
                            <ul>
                              ...
                              <li><i class="fa fa-group" style="margin-right: 10px;"></i><span><a href="Pointstable.html" class="active">Points table</a></span></li>
                                  ...
                                  <div class="row">
                                    <div class="columns large-12"> 
                                      <div class="tableHeader colour0">
                                        <h5 class="subHeading" style="text-align: center;">TCCC LEAGUE POINTS TABLE- 2010</h5>
                                      </div>
                                      <div class="tableContainer">
                                        <table>
                                          <tbody>
                                            ...
                                            <tr>
                                              <td>1</td>
                                              <td style="text-align:left;">THUNDERBOLTS</td>
                                              <td>14</td>
                                              <td>11</td>
                                              <td>1</td>
                                              <td>2</td>
                                            ...
                                            <tr>
                                              <td>2</td>
                                              <td style="text-align:left;">KPMG</td>
                                              <td>14</td>
                                              <td>10</td>
                                              <td>3</td>
                                              <td>1</td>
                                            ...
                                            <tr>
                                              <td>6</td>
                                              <td style="text-align:left;">BMCC</td>
                                              <td>14</td>
                                              <td>7</td>
                                              <td>5</td>
                                              <td>2</td>
                                            ...
                                            <tr>
                                              <td>7</td>
                                              <td style="text-align:left;">LUMBER JACK</td>
                                              <td>14</td>
                                              <td>2</td>
                                              <td>11</td>
                                              <td>1</td>
                                            ...
                                            <tr>
                                              <td>8</td>
                                              <td style="text-align:left;">OWCC</td>
                                              <td>14</td>
                                              <td>0</td>
                                              <td>14</td>
                                              <td>0</td>
