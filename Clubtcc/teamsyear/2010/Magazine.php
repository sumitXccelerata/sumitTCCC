                        ...
                        <div class="section">
                          ...
                          <div class="content">
                            <ul>
                              ...
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="Magazine.html" class="active">Magazine</a></span>
                                  ...
                                  <div class="row">
                                    <div class="columns large-12"> 
                                      <div class="tableHeader colour0">
                                        <h5 class="subHeading" style="text-align: center;">Magazine - 2010</h5>
                                      </div>

                                      <div style="margin-top: 10px;">
                                        <table>
                                          <tr style="background: #FFFFFF;">
                                            <td style="font-size: 13px; font-weight: bold;">Magazine - 2010</td>
                                            <td class="pdf_style">
                                            <a href="../../pdf/TCCCMagazine2010.pdf" target="_blank"><img src="../../pdf/View-PDF.png" alt="View PDF" width="80px"></a>
                                            <a href="../../pdf/TCCCMagazine2010.pdf" download="TCCCMagazine2010.pdf"><img src="../../pdf/PDF_button.png" alt="Download" width="80px"></a>
                                            </td>
                                          </tr>
                                        </table>
                                      <br />
                                      <img src="../../img/tcccmagazine2010.jpg" alt="tcccmagazine2010">
                                    </div>
