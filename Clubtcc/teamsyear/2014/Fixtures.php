                  ...
                  <div class="listNavContainer"> 
                    ...
                    <div class="left-menu">
                      ...
                      <div class="accordion">
                        ...
                        <div class="section">
                          <input type="radio" name="accordion-1" id="section-2" checked="checked"/>
                          <label for="section-2"><span style="color:white"><a href="teams.html"></a> TCCC League 2014</span></label>
                          <div class="content">
                            <ul>
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="teams.html">Teams</a></span></li>
                              <li><i class="fa fa-cog" style="margin-right: 10px;"></i><span><a href="Fixtures.html" class="active">Fixtures</a></span></li>
                                  ...
                                  <div class="row">
                                    <div class="columns large-12"> 
                                      <div class="tableHeader colour0">
                                        <h5 class="subHeading" style="text-align: center;">TORONTO CITY CRICKET CLUB( TCCC) LEAGUE 2014 - SCHEDULE</h5>
                                      </div>
                                      <div class="tableContainer">
                                        <table>
                                          <tbody>
                                            ...
                                            <tr>
                                              <td>5</td>
                                              <td>5/25/14 - Sunday</td>
                                              <td>7.30 am - 11.30 am</td>
                                              <td>KPMG (H) vs BMCC</td>
                                            ...
                                            <tr>
                                              <td>10</td>
                                              <td>6/22/14 - Sunday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>KPMG vs SSCC (H)</td>
                                              <td>BMO (H) vs JAI HO</td>
                                            </tr>

                                            <tr>
                                              <td>11</td>
                                              <td>6/28/14 - Saturday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>BMCC vs TLJ (H)</td>
                                            ...
                                            <tr>
                                              <td>13</td>
                                              <td>7/5/14 - Saturday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>SSCC vs JAI HO (H)</td>
                                              <td>TLJ vs ETB (H)</td>
                                            </tr>
                                            ...
                                            <tr>
                                              <td>18</td>
                                              <td>7/20/14 - Sunday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>SSCC vs BMO (H)</td>
                                              <td>JAI HO (H) vs TLJ</td>
                                            </tr>

                                            <tr>
                                              <td>19</td>
                                              <td>7/26/14 - Saturday</td>
                                              <td>7.30 am - 11.30am</td>
                                            ...
                                            <tr>
                                              <td>23</td>
                                              <td>8/9/14 - Saturday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>JAI HO (H) vs ETB</td>
                                              <td>SSCC vs TLJ (H)</td>
                                            </tr>

                                            <tr>
                                              <td>24</td>
                                              <td>8/10/14 - Sunday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>BMCC vs ETB (H)</td>
                                            ...
                                            <tr>
                                              <td>28</td>
                                              <td>8/24/14 - Sunday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>SSCC (H) vs JAI HO</td>
                                              <td>KPMG vs BMCC (H)</td>
                                            </tr>

                                            <tr>
                                              <td>29</td>
                                              <td>8/30/14 - Saturday</td>
                                              <td>7.30 am - 11.30am</td>
                                              <td>ETB (H) vs ACC</td>
                                              <td>SSCC (H) vs TLJ</td>
                                            </tr>
