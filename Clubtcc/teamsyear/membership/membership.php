                  ...
                  <div class="listNavContainer"> 
                    <div class="left-menu"> 
                      <div class="accordion">
                        ...
                        <div class="section">
                          <input type="radio" name="accordion-1" id="section-8"  checked="checked"/>
                          <label for="section-8"><span style="color:white">Member Ship</span></label>
                          <div class="content">
                            <ul>
                              <li><i class="fa fa-cog" style="margin-right: 10px;"></i><span><a href="membership.html" class="active">Member ship</a></span></li>
                              <li><i class="fa fa-sitemap" style="margin-right: 10px;"></i><span><a href="ListofMembership.html">List Membership</a></span></li>
                            </ul>
                          </div>
                        </div>
                      </div><!-- accordion --> 
                                  ...
                                  <div class="row">
                                    <div class="columns large-12"> 
                                      <div class="tableHeader colour0">
                                        <h5 class="subHeading" style="text-align: center;">Membership Application Form</h5>
                                      </div>

                                      <div style="margin-top: 10px;">
                                       <h3 style="text-align:center;color: rgb(0, 0, 170);">Please send a request for membership form to:</h3>

                                       <div align="center">
                                         <font size="3">
                                         <font face="Verdana" size="3" color="#0000aa">
                                         <a href="mailto:membership@clubtcc.ca">membership@clubtcc.ca</a>
                                         </font>
                                         </font>
                                       </div>
                                      <br />
                                      <center><img src="../../img/tcccmembershipform.jpg" alt="tcccmembershipform"></center>
                                      <br />
