                        ...
                        <div class="section">
                          ...
                          <div class="content">
                            <ul>
                              ...
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="../2011/Event.html">Event Winner</a></span></li>
                            </ul>
                          </div>
                        </div>
                        <div class="section">
                          ...
                          <div class="content">
                            <ul>
                              ...
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="../2010/Magazine.html">Magazine</a></span></li>
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="../2010/FinalStanding.html">Final Standing</a></span></li>
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="../2010/CricketFestival.html">Cricket Festival</a></span></li>
                            </ul>
                          </div>
                        </div>
                        <div class="section">
                          <input type="radio" name="accordion-1" id="section-7"  checked="checked"/>
                          <label for="section-7"><span style="color:white">TCCC League 2009</span></label>
                          <div class="content">
                            <ul>
                              <li><i class="fa fa-cog" style="margin-right: 10px;"></i><span><a href="InviteFestival.html">Invite Festival</a></span></li>
                              <li><i class="fa fa-sitemap" style="margin-right: 10px;"></i><span><a href="CricketFestival.html" class="active">Cricket Festival</a></span></li>
                            </ul>
                          </div>
                        </div>
                        <div class="section">
                                  ...
                                  <div class="row">
                                    <div class="columns large-12"> 
                                      <div class="tableHeader colour0">
                                        <h5 class="subHeading" style="text-align: center;">Media Release - 2009</h5>
                                      </div>

                                      <div style="margin-top: 10px;">
                                       <h3 style="text-align:center;color: rgb(0, 0, 170);">Can-India Media Release</h3>
                                      <br />
                                      <center><img src="../../img/canindiamediarelease.jpg" alt="canindiamediarelease"></center>
                                      <br />
                                      <h3 style="text-align:center;color: rgb(0, 0, 170);">India Journal Media Release</h3>
                                      <br />
                                      <center><img src="../../img/indiajournalmediarelease.jpg" alt="indiajournalmediarelease"></center>
                                    </div>
