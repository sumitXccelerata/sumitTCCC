                    ...
                    <div class="left-menu"> 
                      <div class="accordion">
                        ...
                        <div class="section">
                          ...
                          <div class="content">
                            <ul>
                              <li><i class="fa fa-cog" style="margin-right: 10px;"></i><span><a href="InviteFestival.html" class="active">Invite Festival</a></span></li>
                              <li><i class="fa fa-sitemap" style="margin-right: 10px;"></i><span><a href="CricketFestival.html" >Cricket Festival</a></span></li>
                            </ul>
                          </div>
                        </div>
                        <div class="section">
                                  ...
                                  <div class="row">
                                    <div class="columns large-12"> 
                                      <div class="tableHeader colour0">
                                        <h5 class="subHeading" style="text-align: center;">Tccc Invite Festival - 2009</h5>
                                      </div>

                                      <div style="margin-top: 10px;">
                                      <center><img src="../../img/outsidepage_tccc_invite0409.jpg" alt="outsidepage_tccc_invite0409"></center>
                                      <br />
                                      <center><img src="../../img/insidepage_tccc_invite0409.jpg" alt="insidepage_tccc_invite0409"></center>
                                    </div>
