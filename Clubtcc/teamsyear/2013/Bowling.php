                    ...
                    <div class="left-menu">
                      ...
                      <div class="accordion">
                        <div class="section">
                          ...
                          <label for="section-2"><span style="color:white"><a href="../2015/teams.html"></a> TCCC League 2015</span></label>
                          <div class="content">
                             <ul>
                        ...
                        <div class="section">
                          ...
                          <label for="section-4"><span style="color:white"><a href="teams.html"></a> TCCC League 2013</span></label>
                          <div class="content">
                            <ul>
                              <li><i class="fa fa-user" style="margin-right: 10px;"></i><span><a href="teams.html">Teams</a></span></li>
                              <li><i class="fa fa-cog" style="margin-right: 10px;"></i><span><a href="Fixtures.html">Fixtures</span></a></li>
                              <li><i class="fa fa-group" style="margin-right: 10px;"></i><span><a href="Pointstable.html">Pointstable</a></span></li>
                              ...
                              <li><i class="fa fa-share" style="margin-right: 10px;"></i><span><a href="Bowling.html"class="active">Bowling Statistics</a></span></li>
                            </ul>
                          </div>
                        </div>
                      </div>
