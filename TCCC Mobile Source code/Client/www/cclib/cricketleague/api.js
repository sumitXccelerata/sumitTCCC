...
APIUtils.URLS = {
		...
		// Client TeamSquad
		getTeamPlayersURL:function(obj){
			return APIUtils.SERVER+"client.php?type=teamplayers";
		},
		...
		getCreateMultiMatchHasTeamURL:function(matchHasTeam){
			return APIUtils.SERVER+"match_has_team.php?type=createmulti&match_id="+matchHasTeam.matchId+"&team_ids="+matchHasTeam.teamId;
		},
		...
		getCreateVideosURL:function(videos){
			return APIUtils.SERVER+"videos.php?type=create&video_title="+videos.videoTitle+"&video_description="+videos.videoDescription+"&video_type="+videos.videoType+"&video_type_id="+videos.videoTypeId+"&video_logo="+videos.PicPath+"&shortname="+videos.shortname+"&duration="+videos.duration;
		},
		getUpdateVideosURL:function(videos){
			return APIUtils.SERVER+"videos.php?type=update&video_id="+videos.videoId+"&video_title="+videos.videoTitle+"&video_description="+videos.videoDescription+"&video_type="+videos.videoType+"video_type_id="+videos.videoTypeId+"&video_logo="+videos.PicPath+"&shortname="+videos.shortname+"&duration="+videos.duration;
		},
		...
		// Client Points
		getClientListPointsURL:function(obj){
			return APIUtils.SERVER+"client.php?type=points";
		},
		// user
		...
		getClientFixturesURL:function(obj){
			// console.log(obj)
			return APIUtils.SERVER+"client.php?type=fixtures";
		},
		getClientResultsURL:function(obj){
			// console.log(obj)
			return APIUtils.SERVER+"client.php?type=results";
		}
}
...
// Client TeamSquad
APIUtils.getTeamPlayers = function(obj,myFunction) {
	var url = APIUtils.URLS.getTeamPlayersURL(obj);
	//console.log(url)
	callAjax(url,null,"GET",myFunction);
}
...
// Client Points
APIUtils.getClientListPoints = function(obj,myFunction) {
	var url = APIUtils.URLS.getClientListPointsURL(obj);
	//console.log(url)
	callAjax(url,null,"GET",myFunction);
}
...
APIUtils.updateScoreCard = function(obj,myFunction) {
	...
	callAjax(url,obj,"POST",myFunction);
}


//Client Fixtures
APIUtils.getClientFixtures = function(obj,myFunction) {
	var url = APIUtils.URLS.getClientFixturesURL(obj);
	// console.log(url)
	callAjax(url,null,"GET",myFunction);
}
...
//Client Results
APIUtils.getClientResults = function(obj,myFunction) {
	var url = APIUtils.URLS.getClientResultsURL(obj);
	// console.log(url)
	callAjax(url,null,"GET",myFunction);
}
